...
import '../models/cupones.dart';
import '../models/credit_card.dart';
import '../models/ordencomida.dart';
import '../models/orden.dart';
import '../models/estadorden.dart';
import '../models/pagos.dart';
...
class CheckoutController extends CartController {
  ...
  void addOrder(List<Cart> carts) async {
    ...
    _order.deliveryFee = payment.method == 'Pago en el Local' ? 0 : carts[0].food.restaurant.deliveryFee;
