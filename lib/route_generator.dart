...
import 'src/pages/configuracion.dart';
import 'src/pages/signup.dart';
import 'src/pages/paginaCarga.dart';
...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/CashOnDelivery':
        return MaterialPageRoute(builder: (_) => OrderSuccessWidget(routeArgument: RouteArgument(param: 'Cancelar al Delivery')));
      case '/PayOnPickup':
        return MaterialPageRoute(builder: (_) => OrderSuccessWidget(routeArgument: RouteArgument(param: 'Pagar en el Local')));
      case '/PayPal':
