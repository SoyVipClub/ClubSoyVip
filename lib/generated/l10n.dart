...
class S {
  ...
  /// `Haga clic en la comida para obtener más detalles al respecto.`
  ...
  /// `Cuéntanos sobre el restaurante`
  ...
  /// `Restaurantes cerca de su ubicación actual`
  ...
  /// `Recoge tu comida del restaurante`
  ...
  /// `Esta comida se añadió al carrito`
  ...
  /// `Haga clic para confirmar su dirección y pago o Mantenga pulsada la tecla para editar su dirección`
  ...
  /// `Haga clic para pagar con su tarjeta Visa`
  ...
  /// `Haga clic para pagar con Paypal`
  ...
  /// `Haga clic para pagar en efectivo al Delivery`
  ...
  /// `Haga clic para pagar en el local`
  ...
  /// `Dirección de entrega fuera del alcanze de entregas de este restaurante.`
  ...
  /// `Este restaurante no es compatible con el método de entrega.`
  ...
  /// `Uno o más alimentos en su carrito no son entregables`
  ...
  /// `Cargando...No tienes ninguna orden`
  ...
  /// `Haga clic para pagar con el método RazorPay`
  ...
  /// `Desliza el dedo a la izquierda de la notificación para eliminarla o leerla / no leerla`
